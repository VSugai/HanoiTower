...
class Haste {
    ...
    push(disc) {
        if (this.discs.length > 0) {
            this.discs.unshift(disc); // insere disco no topo
        }
        else {
    ...
    pop() {
        var disc = this.discs.shift(); // remove o disco do topo
        return disc;
    }
    getPegContainer() {
...
Game.prototype.createDiscs=function(peg){
    ...
    for(var e=0;e<this.options.qtdDiscos;e++){
        ...
        var disco=new Disco({
            id:e+1,
            width:100+(e*75), // Tamanho do disco
...
Game.prototype.turnPegDroppable=function(f){
    ...
    var execute=function(i,d){
        ...
        //Transfere, DESEMPILHA, remove de uma pilha, retorna seu valor e logo em seguida adiciona a outra
